<%@ Page Title="Books" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BookList.aspx.cs" Inherits="BooksShopOnline.BookList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        GroupItemCount="4"
         ...
         <br />
         <span>
         <b>Giá Tiền: </b><%#:String.Format("{0:c}",Item.UnitPrice)%>
         </span>
         <br />
         </td>
         </tr>
